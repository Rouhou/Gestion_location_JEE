...
<div style="text-align:center;background:#fff;padding:3rem;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,.1);max-width:450px">
    ...
    <h1 style="font-size:4rem;color:#1a237e;font-weight:800">404</h1>
    <h2 style="color:#424242;margin-bottom:.8rem">Page introuvable</h2>
    <p style="color:#757575;margin-bottom:1.5rem">La page que vous cherchez n'existe pas ou a été déplacée.</p>
