...
<head>
    ...
    <title>${empty immeuble ? 'Nouvel immeuble' : 'Modifier immeuble'} — GestionLoc</title>
...
<div class="layout">
    ...
    <div class="main-content">
        <div class="topbar">
            ...
            <a href="${pageContext.request.contextPath}/proprietaire/immeubles" class="btn btn-outline btn-sm">← Retour</a>
        </div>
        <div class="page-body">
            <c:if test="${not empty erreur}"><div class="alert alert-danger">${erreur}</div></c:if>

            <div class="card" style="max-width:700px;margin:0 auto">
                <div class="card-header"><h2>${empty immeuble ? 'Nouveau' : 'Modifier'} immeuble</h2></div>
                <div class="card-body">
                    <form method="post" action="${pageContext.request.contextPath}/proprietaire/immeubles">
                        ...
                        <div class="form-grid">
                            <div class="form-group full">
                                ...
                                <input type="text" name="nom" required placeholder="Résidence Téranga" value="${immeuble.nom}"/>
                            </div>
                            <div class="form-group full">
                                <label>Adresse *</label>
                            ...
                            <div class="form-group full">
                                ...
                                <textarea name="description" placeholder="Description de l'immeuble...">${immeuble.description}</textarea>
                            </div>
                        </div>
