...
<head>
    ...
    <title>Detail contrat — GestionLoc</title>
        ...
        <div class="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 shrink-0">
            ...
            <div class="flex items-center gap-2">
                ...
                <c:if test="${contrat.statut eq 'ACTIF'}">
                    <form method="post" action="${pageContext.request.contextPath}/proprietaire/contrats" class="inline">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    ...
                    <div class="p-5">
                        <dl class="divide-y divide-gray-50">
                            <div class="flex items-center justify-between py-2.5">
                                <dt class="text-sm text-gray-500 w-2/5">Statut</dt>
                                <dd>
                                    <c:choose>
                            ...
                            <div class="flex items-center justify-between py-2.5">
                                ...
                                <dd class="text-sm text-gray-800">
                                    <c:choose>
                                        <c:when test="${not empty contrat.dateFin}">${contrat.dateFinFormattee}</c:when>
                                        <c:otherwise><span class="text-gray-300">Non definie</span></c:otherwise>
                                    </c:choose>
                                </dd>
                            </div>
                            <div class="flex items-center justify-between py-2.5">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <div class="p-5 flex flex-col gap-4">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Unite louee</p>
                            ...
                            <p class="text-sm text-gray-500">
                                ${contrat.unite.nbPieces} piece(s) —
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 border-b border-gray-100">
                            <tr>
                                ...
                                <th class="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider px-5 py-3">Mode de paiement</th>
                        ...
                        <c:if test="${empty contrat.paiements}">
                            <tr><td colspan="6" class="text-center px-5 py-8 text-gray-400">Aucun paiement enregistre pour ce contrat.</td></tr>
                        </c:if>
                        <c:forEach var="p" items="${contrat.paiements}">
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-5 py-3 font-medium text-gray-800">${p.moisConcerne}</td>
